      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-6 pb-20 pt-24 lg:px-12 lg:pb-28">
        ...
        <Reveal delay={1.55}>
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            <a href="#cta" className="btn-gold pulse-glow">
              <Phone className="mr-2 h-4 w-4" /> Call Now
            </a>
            <a href="#cta" className="btn-ghost-gold">
    ...
    <div className="mx-auto max-w-[1480px] px-6 lg:px-12">
      ...
      <Reveal delay={0.3}>
        <div className="mt-10 flex justify-center">
          <a href="#cta" className="btn-gold pulse-glow">Call Now — Get My Personal Quote</a>
        </div>
      </Reveal>
    </div>
  </section>
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-[1480px] flex-col justify-center px-6 py-32 lg:px-12">
        ...
        <Reveal delay={0.4}>
          <div className="mt-12 flex flex-col gap-4 sm:flex-row sm:items-center">
            <a href="tel:+972000000000" className="btn-gold pulse-glow">
              <Phone className="mr-2 h-4 w-4" /> Call Now to Check Availability
            </a>
            <a href="tel:+972000000000" className="btn-ghost-gold">Call Now — Get My Free Quote</a>
          </div>
    ...
    <div className="mx-auto max-w-[1480px] px-6 lg:px-12">
      <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr_1fr]">
        ...
        <div className="space-y-3">
          ...
          <p className="font-sans text-[15px] text-ivory/85">WhatsApp: <a className="hover:text-gold" href="#">Open chat</a></p>
          <p className="font-sans text-[15px] text-ivory/85">Phone: +972 XX XXX XXXX</p>
